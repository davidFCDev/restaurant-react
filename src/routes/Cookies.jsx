            ...
            <main className='text-container-cookies'>
                ...
                <div className='text-cookies'>
                    ...
                    <div>
                        ...
                        <p>Utilizamos cookies para obtener más información sobre la forma en que los visitantes interactúan con nuestro contenido y nos ayudan a mejorar la experiencia de los usuarios cuando visitan el sitio Web www.puzzlemadrid.com</p>
                    </div>
                    <div>
                        <h2>¿Qué tipos de cookies utiliza esta página web y quién las utiliza?</h2>
                        <p>La información obtenida por las cookies de este sitio Web es tratada por el editor del sitio Web www.puzzlemadrid.com</p>
